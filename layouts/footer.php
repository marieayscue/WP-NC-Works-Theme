...
<div id="footer-1" class="widget-area col-md-3" role="complementary">
	<?php dynamic_sidebar( 'footer-1' ); ?>
</div>

<div id="footer-2" class="widget-area col-md-3" role="complementary">
	<?php dynamic_sidebar( 'footer-2' ); ?>
</div>

<div id="footer-3" class="widget-area col-md-3" role="complementary">
	<?php dynamic_sidebar( 'footer-3' ); ?>
</div>

<div id="footer-4" class="widget-area col-md-3" role="complementary">
